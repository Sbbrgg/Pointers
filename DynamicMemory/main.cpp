...
#ifdef CLEAR_VARIANT_ONE
void Clear(int** arr, const int rows);
#endif // CLEAR_VARIANT_ONE
void Clear(int**& arr, const int rows/*, const int cols = 0*/);	//можно передавать cols,
...
//#define CLEAR_VARIANT_ONE
#define CLEAR_VARIANT_TWO
void main()
{
	setlocale(LC_ALL, "");
